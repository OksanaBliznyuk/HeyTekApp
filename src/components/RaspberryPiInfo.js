    ...
    <React.Fragment>
      ...
      >
        <Box sx={{ ...style, width: 400, height: 300 }}>
          <img src={raspberryPi} alt="Bildebeskrivelse" className="modal-img" />
...
const RaspberryPiInfo = ({ equipment }) => {
    ...
    <div>
      ...
      >
        <Box sx={{ ...style, width: 400 }}>
          ...
          Raspberry Pi er en programmerbar datamaskin (64-bits firekjerners prosessor på 1,5 GHz, støtte for to skjermer med oppløsninger på opptil 4K på 60 fps, opptil 4 GB RAM, dual-band 2.4/5.0 GHz trådløst LAN, Bluetooth 5.0 / BLE True Gigabit Ethernet, USB 3.0 ). Vi har 14 sett tilgjengelig.
          </p>
          <ChildModal />
