// EditionRoboterInfo.js
import React, { useState } from "react";
import { Modal, Button, Box } from "@mui/material";
import expansion from "../assets/images/edison_expansion.png";
    ...
    <React.Fragment>
      ...
      >
        <Box sx={{ ...style, width: 400, height: 300 }}>
          <img src={expansion} alt="Bildebeskrivelse" className="modal-img" />
...
const EdisonRobotsetInfo = ({ equipment }) => {
...
export default EdisonRobotsetInfo;