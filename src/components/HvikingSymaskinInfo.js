// HusguarnaVikOverl.js
// ArduinoInfo.js
import React, { useState } from "react";
import { Modal, Button, Box } from "@mui/material";
import symaskin from "../assets/images/symaskin.jpg";
    ...
    <React.Fragment>
      ...
      >
        <Box sx={{ ...style, width: 400, height: 300 }}>
          <img src={symaskin} alt="Bildebeskrivelse" className="modal-img" />
...
const HvikingSymaskinInfo = ({ equipment }) => {
      ...
      >
        <Box sx={{ ...style, width: 400 }}>
          ...
          <p id="equipment-modal-description">
            Vi har tre ulike typer symaskiner, hvor av en er en
            overlock. Disse befinner seg på rom N313, men kan lånes ut av rommet
            etter avtale.
          </p>
          <ChildModal />
...
export default HvikingSymaskinInfo;
